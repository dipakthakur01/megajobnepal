          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="absolute right-3 top-1/2 transform -translate-y-1/2 h-auto p-0 text-gray-400 hover:text-gray-500 focus:outline-none transition-none leading-none"
