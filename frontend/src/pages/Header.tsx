                ...
                <div className="flex items-center space-x-4">
                  ...
                  {(currentUser.user_type === 'admin' || currentUser.user_type === 'super_admin') && (
                    <div className="relative">
                      <button
                        onMouseEnter={() => setShowSuperAdminDropdown(true)}
                        onMouseLeave={() => setShowSuperAdminDropdown(false)}
                      ...
                      {showSuperAdminDropdown && (
                        ...
                        >
                          <div className="p-2">
                            <button
                              onClick={() => handleNavigationClick('super-admin')}
                              className="flex items-center space-x-3 w-full p-2 text-left hover:bg-gray-50 rounded"
                            >
                ...
                {currentUser ? (
                  <div className="space-y-2">
                    {(currentUser.user_type === 'admin' || currentUser.user_type === 'super_admin') ? (
                      <Button
                        onClick={() => {
                          handleNavigationClick('super-admin');
                          setIsMobileMenuOpen(false);
                        }}
                        variant="outline"
                        size="sm"
